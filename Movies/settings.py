...
SECRET_KEY = 'django-insecure-o-)89_^8t%6!dvg5@ioodf$h00t4+kut_!(&rqro!o36jok!o6'
...
#Essa parte serve pra fazer com que, pra consultar nosso BD, deverá estar logado e autenticado. Ou seja, quem não tiver acesso, não pode
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 10, #Isso define a quantidade de páginas retornadas pela API
}
...
CORS_ALLOWED_ORIGINS = [ #Para permitir que o django envie informação pra alguem, é preciso informar aqui quem ele permite receber
    'http://localhost:8100', #essa é a url do app em ionic
]
